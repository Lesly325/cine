...
from .views import HomeView, OrderListView, OrderSuccessView, SeatSelectionView, ShowtimeDetailView, SnackDetailView, SnackListView, TicketPDFView,OrderConfirmView
